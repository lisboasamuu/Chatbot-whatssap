...
export interface AuthenticatedCompany extends Company { email: string; }
...
export interface WhatsAppStatus { state:WhatsAppConnectionState; ready:boolean; qrAvailable:boolean; lastError:string|null; enabled:boolean; }
